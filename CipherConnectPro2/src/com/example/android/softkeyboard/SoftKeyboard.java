...
public class SoftKeyboard extends InputMethodService implements
    ...
    public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        else if (Language.equals("Fr"))  // French
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_fr);
        	mSecondlanguage = true;
        }
        else if (Language.equals("De"))  // German
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_de);
        	mSecondlanguage = true;
        }
        else if (Language.equals("It"))  // Italian
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_it);
        	mSecondlanguage = true;            
        }
        else if (Language.equals("Pt"))  // Portuguese
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_pt);
        	mSecondlanguage = true;
        }
        else if (Language.equals("Ru"))  // Russian
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_ru);
        	mSecondlanguage = true;
        }
        else if (Language.equals("Es"))  // Spanish
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_es);
        	mSecondlanguage = true;
        }
        else
        {
        	mLangKeyboard = new LatinKeyboard(this, R.xml.qwerty_none);
        	mSecondlanguage = false;
        }
