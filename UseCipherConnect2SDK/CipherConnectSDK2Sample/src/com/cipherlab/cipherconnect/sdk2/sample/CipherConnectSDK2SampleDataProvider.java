...
public class CipherConnectSDK2SampleDataProvider {
	
	private final String FILE_REMOTE_PATH = "/sdcard/";
	private final String FILE_NAME = "CipherConnectSDKSample.txt";
	...
	public CipherConnectSDK2SampleDataProvider(Context context){
...
//		path += "/"+FILE_NAME;
	...
	public CipherConnectSDK2SampleDataObject AddQuantity(String barcode) {
		CipherConnectSDK2SampleDataObject obj = this.getObject(barcode);
		if(obj==null)
			return null;
	...
	public CipherConnectSDK2SampleDataObject DeleteQuantity(String barcode) {
		CipherConnectSDK2SampleDataObject obj = this.getObject(barcode);
		if(obj==null)
			return null;
	...
	private CipherConnectSDK2SampleDataObject getObject(String barcode) {
		if(barcode==null)
			return null;
		if(barcode.length()==0)
			return null;
		...
		CipherConnectSDK2SampleDataObject obj = new CipherConnectSDK2SampleDataObject(code,name,iquantity,picture_path,company,description);
		System.out.println("getObject("+barcode+").obj:"+obj);
		return obj;
	}
	
	private void setObject(CipherConnectSDK2SampleDataObject obj) {
		if(obj==null)
			return;
